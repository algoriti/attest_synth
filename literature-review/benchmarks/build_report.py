...
```bash
python "literature-review/benchmarks/run_benchmark.py"
python "literature-review/benchmarks/rule_examples.py"
python "literature-review/benchmarks/build_report.py"
python "literature-review/benchmarks/verify_artifacts.py"
```
